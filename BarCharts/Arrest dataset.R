...
nypd1 <- filter(nypd1, SUSPECT_ARRESTED_FLAG == 1)
...
nypd <- select(nypd1, "Arrested", "Frisked", "Searched", "Weapon", "HandCuff", "PepperSpray", "Firearm", "Other", "CEW", "Instruction", "Stopped")
